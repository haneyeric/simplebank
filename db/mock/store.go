...
// Source: github.com/haneyeric/simplebank/db/sqlc (interfaces: Store)
...
import (
	...
	sqlc "github.com/haneyeric/simplebank/db/sqlc"
)
...
func (m *MockStore) CreateTransfers(arg0 context.Context, arg1 sqlc.CreateTransfersParams) (sqlc.Transfer, error) {
	m.ctrl.T.Helper()
